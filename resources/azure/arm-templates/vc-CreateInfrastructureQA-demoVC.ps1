...
$DestResourceGroupName = "QA-demoVC"

$TemplateFile = "${env:WORKSPACE}\resources\azure\azuredeployQA-demoVC.json"
$TemplateParametersFile = "${env:WORKSPACE}\resources\azure\azuredeployQA-demoVC_parameters.json"
