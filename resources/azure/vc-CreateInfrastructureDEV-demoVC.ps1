...
$TemplateFile = "${env:WORKSPACE}\resources\azure\azuredeployDEV-demoVC.json"
$TemplateParametersFile = "${env:WORKSPACE}\resources\azure\azuredeployDEV-demoVC_parameters.json"
