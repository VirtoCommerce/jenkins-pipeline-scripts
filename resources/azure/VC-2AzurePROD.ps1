...
& "${env:Utils}\AzCopy10\AzCopy" cp $SourceDir https://$($AzureBlobName).blob.core.windows.net/$StoreName$token --recursive --exclude-pattern="*.page" --overwrite true #--delete-destination=true
