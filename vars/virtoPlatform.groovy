...
def call(body) {
	...
	node
	{
		...
		try {
			...
			office365ConnectorSend message: "{env.JOB_NAME} - Build # ${currentBuild.number} - ${currentBuild.currentResult}!", status:currentBuild.result, webhookUrl:env.O365_WEBHOOK
