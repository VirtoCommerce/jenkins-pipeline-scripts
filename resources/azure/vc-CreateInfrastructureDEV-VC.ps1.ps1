...
$TemplateFile = "${env:WORKSPACE}@libs\virto-shared-library\resources\azure\DEV-VC-template.json"
$TemplateParametersFile = "${env:WORKSPACE}@libs\virto-shared-library\resources\azure\DEV-VC-templatre-properties.json"
