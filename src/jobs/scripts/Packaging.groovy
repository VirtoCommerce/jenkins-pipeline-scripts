    ...
    */
    ...
    def static runBuild(context, solution)
    {
        ...
        context.withSonarQubeEnv('VC Sonar Server') {
            ...
            context.bat "\"${sqScannerMsBuildHome}\\SonarQube.Scanner.MSBuild.exe\" begin /k:\"${context.env.JOB_NAME}-${context.env.BRANCH_NAME}\" /d:\"sonar.organization=virtocommerce\" /d:sonar.host.url=%SONAR_HOST_URL% /d:sonar.login=%SONAR_AUTH_TOKEN%"
